	...
	public ExecutarMT() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Main.Recebimento(vet, qtdletras.getText(), alfabeto.getText(), letraestados.getText(), qtdestados.getText(), inicial.getText(), qtdfinais.getText(), finais.getText(), marcinicio.getText(), marcbranco.getText());
				dispose();
			}
		});
