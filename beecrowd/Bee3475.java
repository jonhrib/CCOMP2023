...
public class Bee3475 {
	...
	public static void main (String args []) {
		...
		case ("zero"): System.out.println("0");
			break;
		case ("um"): System.out.println("1");
			break;
		case ("dois"): System.out.println("2");
			break;
		case ("tres"): System.out.println("3");
			break;
		case ("quatro"): System.out.println("4");
			break;
		case ("cinco"): System.out.println("5");
			break;
		case ("seis"): System.out.println("6");
			break;
		case ("sete"): System.out.println("7");
			break;
		case ("oito"): System.out.println("8");
			break;
		case ("nove"): System.out.println("9");
			break;
